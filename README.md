...
5. You may also use the generate feature. To do so, select a table, column, operator and enter criteria. The sql statement will be automatically generated in the query box.
